...
export default function Mail({ saved, handleSave }) {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://learsiateam.000webhostapp.com/app.php", {
      method: "POST",
      body: data
    })
      .then((res) => {
        ...
        res.text().then((text) => {
          if (text.includes("email was sent")) {
            ...
            console.log(saved);
            var savedStr = JSON.stringify(saved);
            localStorage.setItem("sent", savedStr);
          } else {
